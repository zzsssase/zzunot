...
◈ رفع مشرف
»**لرفع شخص مشرف قم بالرد على رسالته او يوزه يجب ان تڪون مشرف**

◈ تنزيل مشرف 
 » **لتنزيل شخص من الاشراف بالرد على رسالته او يوزه يجب يكون انت من قام برفعه**

◈ `حظر`
» **لحظر الشخص من المجموعه يجب ان تڪون مشرف**

◈ `الغاء حظر `
» **لرفع الحظر عن الشخص في المجموعه**

◈ `طرد` 
» **لطرد الشخص من المجموعه يجب ان تڪون مشرف**

◈ ` تثبيت ` 
» **قم بالرد على الرساله لتثبيتها**

◈ ` الغاء التثبيت ` 
» **بالرد علئ الرساله التي تريد الغاء تثبيتها**

◈ ` تثبيت مؤقت ` 
» **بالرد على الرساله لتثبيتها وقت محدود**

◈ ` المثبت ` 
» **لعرض الرسائل المثبته في المجموعه**

◈ `حذف`
 » ** لحذف جميـع رسائل الشخص في المجموعه**

◈ `مسح`
» **قم بالرد على الرسالة لتي تريد حذفها**

◈ `تنظيف`
» **قم بكتابة الامر + عدد الرسايل ليتم حذف الرسائل في المجموعه**
"""
...
@kazu_cmd(pattern="تثبيت$", manager=True, require="pin_messages", fullsudo=True)
async def pin(msg):
    if not msg.is_reply:
